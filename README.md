https://sirc18.github.io/restaurantepf/
...
1.  **Frontend (React + Vite)**: 
    ...
    *   Ejecución: `npm run dev`
      ### Desarrollo del Frontend:
        A. **Interfaz**: Creación de componentes con **React-Bootstrap** y **Lucide-React** para diseño moderno.
        B. **Navegación**: Se usa React Router para moverse entre páginas, por ejemplo, de la lista de restaurantes a los        detalles de un plato.
        C. **Conexión con datos**: Se obtiene la información de los platos y pedidos desde un servidor usando Fetch API, y se guarda en el estado para mostrarla en la pantalla.
